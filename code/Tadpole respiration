...
# AICc calculation
normAICc <- AICc(numParams=2, loglik=ll_norm, n=length(respData$PerfTemp))
normAICc
...
# AICc calculation
lnormAICc <- AICc(numParams=2, loglik=ll_lnorm, n=length(respData$PerfTemp))
lnormAICc
...
# AICc calculation
normAICc <- AICc(numParams=4, loglik=ll_norm, n=length(respData$PerfTemp))
normAICc
...
# AICc calculation
lnormAICc <- AICc(numParams=4, loglik=ll_lnorm, n=length(respData$PerfTemp))
lnormAICc
...
# AIC calculation
normAICc <- AICc(numParams=6, loglik=ll_norm, n=length(respData$PerfTemp))
normAICc
...
# AICc calculation
lnormAICc <- AICc(numParams=6, loglik=ll_lnorm, n=length(respData$PerfTemp))
lnormAICc
